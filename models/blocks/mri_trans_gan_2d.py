...
from models.layers.convolutions import Conv2D,UpSampalingConv2D
...
class Conv7S1(tf.keras.Model):#c7s1_k
    def __init__(self,
        ...
        self.l1_conv = Conv2D(filters=filters,
                              kernel_size=[7,7],
                              strides=[1,1],
                              padding='REFLECT',
                              use_bias=use_bias,
        ...
        if specific_out_dtype is None:
            ...
            self.l3_activation = Activation(activation,dtype=specific_out_dtype)
...
class ResBlock(tf.keras.Model):#rk
    def __init__(self,
        ...
        self.l2_norm = InstanceNormalization(dtype=dtype)
        self.l3_activation =Activation('relu',dtype=dtype)
        self.l4_conv= Conv2D(filters=filters,
                             kernel_size=[3,3],
                             strides=[1,1],
                             padding='REFLECT',
                             use_bias=use_bias,
...
class UpSampling(tf.keras.Model):#uk
    def __init__(self,
        ...
        self.l1_up= UpSampalingConv2D(filters=filters,
                                      kernel_size=[3,3],
                                      strides=[2,2],
                                      padding='SAME',
                                      use_bias=use_bias,
