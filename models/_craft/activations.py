...
from utils.logging_helper import init_or_get_logger
__all__ = [
    "activation_slect",
    # "Dropout",
    "Activation",
]
__logger = init_or_get_logger("BuildingLogger")
def activation_slect(activation_name):# 统一用tf.keras.activations内实现
    if activation_name == "relu":
        return tf.keras.activations.relu
    elif activation_name == "leaky_relu":
        __logger.warning("You have used leaky_relu! Remember give specific 'alpha' parameter to it!Default threshold is 0.")
        return tf.keras.activations.relu
