...
def _ssim2d(x,y,max_val=1.0,filter_size=11,filter_sigma=1.5,k1=0.01,k2=0.03,compensation=1.0):
    """
...
def _ssim3d(x,y,max_val=1.0,filter_size=11,filter_sigma=1.5,k1=0.01,k2=0.03,compensation=1.0):
    """
    The correct compensation factor is `1.0 - tf.reduce_sum(tf.square(kernel))`,
    but to match MATLAB implementation of MS-SSIM, we use 1.0 instead.
    即做无偏估计时,传入(1 - \sum_i w_i ^ 2) 一般情况下为1.0
