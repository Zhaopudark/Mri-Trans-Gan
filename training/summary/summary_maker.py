...
"""
import datetime
from training.summary._summary4local import LocalLogsMaker as _LocalLogsMaker
from training.summary._summary4tensorboard import SummaryMaker as _SummaryMaker
__all__ = [
    'LogsMaker',
]
class LogsMaker():
