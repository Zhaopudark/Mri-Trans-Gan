...
class Optimizer():
    ...
    def _schedule_check(self,learning_rate,args=None):
        ...
        if learning_rate_schedule == "cosine_decay":
            ...
            decay_steps:{}
            alpha:{}
            """.format(self._description,learning_rate_schedule,learning_rate,decay_steps,alpha))
            ...
            m_mul:{}
            alpha:{}
            """.format(self._description,learning_rate_schedule,learning_rate,first_decay_steps,t_mul,m_mul,alpha))
            ...
            decay_rate:{}
            staircase:{}
            """.format(self._description,learning_rate_schedule,learning_rate,decay_steps,decay_rate,staircase))
            ...
            boundaries:{}
            values:{}
            """.format(self._description,learning_rate_schedule,boundaries,values))
            ...
            power:{}
            cycle:{}
            """.format(self._description,learning_rate_schedule,learning_rate,decay_steps,end_learning_rate,power,cycle))
            ...
            start_step:{}
            staircase:{}
            """.format(self._description,learning_rate_schedule,learning_rate,decay_steps,decay_rate,start_step,staircase))
        else:
            print("""
            {} 
            Unsupported learning_rate_schedule:{}
            No schedule will be used.
            """.format(self._description,learning_rate_schedule))
